defmodule XxxxXxxxWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      XxxxXxxxWeb.Coherence.ViewHelps.coherence_links/3
  ...
  import XxxxXxxxWeb.Gettext

  @type conn :: Plug.Conn.t()
  @type schema :: Ecto.Schema.t()

  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers XxxxXxxxWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(XxxxXxxxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(XxxxXxxxWeb.Gettext, "errors", msg, opts)
    end
  end
